...
export const resourceByIdFeatureSlice = createSlice({
  ...
  reducers: {
    toggleGeResourceById: (state) => {
      state.state.isLoading = true;
    },
    toggleGeResourceByIdSuccess: (state, action) => ({
      ...state,
      state: {
        ...state.state,
        error: null,
    ...
    toggleGeResourceByIdFailure: (state, action) => ({
      ...state,
      state: {
        ...state.state,
...
export const {
  toggleClearResourceById,
  toggleGeResourceById,
